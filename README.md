...
в связный список, что видно из его вырожденного распределения.

Уже чуть лучше себя показывают хеш-функции длины / первого символа, однако их распределение тоже
далеко от идеального в силу ограничений естественного языка. Так, например, различных букв всего 26, а значит диапазон принимаемых хеш-функцией значений очень ограничен.
Длина строки не лучше: слова длиннее 20 букв в тексте встречаются очень редко, а значит диапазон значений strlen тоже мал.

Хещ-функция суммы байт тоже в силу свойств естественного языка имеет ограниченный набор значений, не способный покрыть весь
размер хештаблицы.

rol/ror и прочие хеши не имеют таких недостатков и потому показывают гораздо лучшие распределения, так как все значения достижимы, что видно из графиков их распределений.
