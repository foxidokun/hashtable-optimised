...
Такое измерение было проведено три раза и усреднено для каждого хеша. Среднеквадратичное отклонение рассчитывалось по формуле: $ \sum {\frac{\sqrt{(x_n^2 - x^2)}}{n}} $
